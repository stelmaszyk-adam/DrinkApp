...
class couponsFlatListContainer extends Component {

  componentDidMount() {
    this.props.fetchData(URL + this.props.navigation.state.params.couponsName, 'flatListCouponsContainer');
  }
